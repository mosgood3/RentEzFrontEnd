      ...
      <div className="flex flex-grow items-center justify-center">
        <div className="rounded-md w-full max-w-md bg-white shadow-lg opacity-100 p-8">
          ...
          <form onSubmit={handleSubmit} className="max-w-sm mx-auto">
            <div class="flex mb-2 w-full space-x-2 rtl:space-x-reverse justify-center items-center">
              <div>
                ...
                <input
                  ...
                  id="code-1"
                  class="block w-9 h-9 py-3 text-sm font-extrabold text-center text-gray-900 bg-white border border-gray-700 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                  required
                />
              </div>
              <div>
            ...
            <button
              className="w-full mb-4 text-[18px] rounded-full mt-6 text-white bg-blue-600 hover:bg-blue-900 hover:text-white py-2 transition-colors duration-300"
              type="submit"
